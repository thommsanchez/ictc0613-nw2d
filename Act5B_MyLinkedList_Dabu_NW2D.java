...
public class Act5B_MyLinkedList_Dabu_NW2D {
     
    public int AreaCode, MemberAge;
    public String FirstName , MiddleName, Surname, TelephoneNumber, MemberGender;
    public Act5B_MyLinkedList_Dabu_NW2D next;
    public static Act5B_MyLinkedList_Dabu_NW2D fNode;
    public static Act5B_MyLinkedList_Dabu_NW2D lNode = null;


public Act5B_MyLinkedList_Dabu_NW2D(String fName, String mName, String lName, int aCode, String TelNum, String Gender, int Age, Act5B_MyLinkedList_Dabu_NW2D n) 
    {
	FirstName = fName; 
	MiddleName = mName;
	Surname = lName;
	...
	next = n;
     ...
     public static void main(String[] args)  {              
        ...
        Act5B_MyLinkedList_Dabu_NW2D n = new Act5B_MyLinkedList_Dabu_NW2D(fName, mName, lName, aCode, TelephoneNumber, Gender, Age, null);
		if(lNode != null) {
			lNode.next = n;
			lNode = n;
		} 
            ...
            Act5B_MyLinkedList_Dabu_NW2D n = fNode;
