package Act5_MyLinkedList_Alki_NW2D;
...
public class Act5_MyLinkedList_Alki_NW2D {
    ...
    public Act5_MyLinkedList_Alki_NW2D(int d, Act5_MyLinkedList_Alki_NW2D n) {
        data = d;
        next = n;  
    }   
    public static void main(String[] args)  {
        ...
        for(int i=0; i<numnodes; i++) {   
           ...
           Act5_MyLinkedList_Alki_NW2D n = new Act5_MyLinkedList_Alki_NW2D(num, null); 
            if(lastNode != null) 
            {
               lastNode.next= n;
               lastNode = n;
